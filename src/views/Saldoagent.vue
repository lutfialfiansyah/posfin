        ...
        <div class="container">
            <div class="main-header">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><router-link to="/saldoagent" class="active"> <img class="icon-menu" src="../assets/images/outline-account-balance-wallet-24-px@3x.png"><p>SALDO AGEN</p></router-link></li>
        ...
        <div class="container">
          ...
          <div class="body-register">
              <ul class="nav nav-tabs">
                    <li class="active"><a  href="#1" data-toggle="tab">OVERBOOKING SALDO</a></li>
                    <li><a  href="#2" data-toggle="tab">LAPORAN TOP UP</a></li>
              ...
              <div class="tab-content">
                        ...
                        <div class="row">
                            ...
                            <form class="form-horizontal">
                              <div class="col-md-12 col-sm-12">
                                <div class="col-md-5 col-sm-5 saldo">
                                    <h5>REKENING ASAL</h5>
                                    <div class="body-saldo">
                                        <div class="form-group">
                                            <label class="control-label col-xs-4">Kode Agent</label>
                                            <div class="col-xs-8"><input type="text" v-model="kode_agent" class="form-control"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-xs-4">Virtual Account</label>
                                            <div class="col-xs-6"><input type="text" v-model="va" class="form-control"></div><p>ENTER</p>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-xs-4">Nama Agent</label>
                                            <div class="col-xs-8"><input type="text" v-model="nama_agent" class="form-control"></div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-xs-4">Posisi Current Saldo Rp.</label>
                                            <div class="col-xs-8"><input type="text" v-model="posisi" class="form-control"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-6 saldo">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="body-nominal">
                                        <div class="form-group nomi">
                                            <label class="control-label col-xs-4">Besar Uang Rp.</label>
                                            <div class="col-xs-8"><input type="text" v-model="nominal" class="form-control" name="nominal" v-validate="'required|numeric|min:3'" data-vv-as="field" :class="{error: errors.has('nominal')}" style="letter-spacing: 1px"><span class="error" v-if="errors.has('nominal')">{{errors.first('nominal')}}</span></div>
                                        </div>
                                        <div class="form-group nomi">
                                            <label class="control-label col-xs-4">Keterangan</label>
                                            <div class="col-xs-8"><input type="text" v-model="ket" class="form-control"></div>
                                        </div>
                                        <div class="tombol-nominal">
                                            <button type="button" @click="isDisabled = !isDisabled" class="btn-nominals">TAMBAH</button>
                                            <button type="button" class="btn-nominal">BATAL</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                              ...
                              <div class="col-md-12 col-sm-12">
                                  <div class="top">
                                      <div class="form-group topup">
                                            ...
                                            <div class="col-sm-3 col-xs-4"><date-picker v-model="startdate" :config="options"></date-picker></div><label class="control-label col-xs-1 laptgls">s.d</label><div class="col-sm-3 colxs-4"><date-picker v-model="lastdate" :config="options"></date-picker> </div><button class="btn-tampil-topup">TAMPILKAN</button>
                                      </div>
                                  </div>
                              </div>
                            </form>
                ...
                <div class="tab-pane" id="4">
                    <div class="body-registrasi">
                        <h5>REK. KORAN MAIN AGEN</h5>
                        <div class="row">
                            <form class="form-horizontal">
                              <div class="col-md-12 col-sm-12">
                                  <div class="top">
                                      <div class="form-group topup">
                                            <label class="control-label col-xs-2 laptgl">Account Buffer</label>
                                            <div class="col-xs-5"><input type="text" class="form-control"></div>
                                      </div>
                                      <div class="form-group topup">
                                            <label class="control-label col-xs-2 laptgl">Nama Pemilik</label>
                                            <div class="col-xs-5"><input type="text" placeholder=" PT. Bakti Wasantara Net (BWN)" class="form-control" disabled></div>
                                      </div>
                                      <div class="form-group topup">
                                            <label class="control-label col-xs-2 laptgl">Tanggal</label>
                                            <div class="col-sm-3"><date-picker v-model="startdate" :config="options"></date-picker></div><label class="control-label col-xs-1 laptgls">s.d</label><div class="col-sm-3"><date-picker v-model="lastdate" :config="options"></date-picker> </div><button class="btn-tampil-topup">TAMPILKAN</button>
                                      </div>
                                  </div>
                              </div>
